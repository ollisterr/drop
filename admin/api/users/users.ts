...
import type { BaseUserPydantic, HTTPValidationError } from ".././model";
...
export const getCurrentUserUsersMeGet = () => {
  return customInstance<unknown>({ url: `/users/me`, method: "get" });
};

export const getGetCurrentUserUsersMeGetQueryKey = () => [`/users/me`];
...
>(options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetCurrentUserUsersMeGetQueryKey();
